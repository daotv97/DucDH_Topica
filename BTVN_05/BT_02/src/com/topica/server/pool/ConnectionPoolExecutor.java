...
public class ConnectionPoolExecutor implements ExecutorService {
    ...
    /**
     * Constructor for ConnectionPoolExecutor class and initialize thread pool.
     *
     * @param corePoolSize
     * @param maximumPoolSize
     * @param workQueue
     */
    public ConnectionPoolExecutor(int corePoolSize, int maximumPoolSize, BlockingQueue<Runnable> workQueue) {
    ...
    private void handleThreadIsRunningAll(Runnable task, int index) {
        ...
        System.out.println("SIZE THEAD POOL: " + workers.size() + "-- SIZE QUEUE: " + workQueue.size());
    }
